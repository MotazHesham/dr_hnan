@extends('consultant.messenger.template')
        ...
        <div class="list-group">
            @forelse($topics as $topic)
                <div class="row list-group-item d-flex">
                    <div class="col-lg-4">
                        <a href="{{ route('consultant.messenger.showMessages', [$topic->id]) }}">
                    ...
                    <div class="col-lg-1 text-center">
                        <form action="{{ route('consultant.messenger.destroyTopic', [$topic->id]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');">
