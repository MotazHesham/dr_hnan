    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.about-uss.update", [$aboutUs->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{{ old('message', $aboutUs->message) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('morals') ? 'is-invalid' : '' }}" type="text" name="morals" id="morals" value="{{ old('morals', $aboutUs->morals) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('manager_word') ? 'is-invalid' : '' }}" name="manager_word" id="manager_word">{{ old('manager_word', $aboutUs->manager_word) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $aboutUs->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $aboutUs->instagram) }}">
