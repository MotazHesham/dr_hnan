        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.about-uss.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('morals') ? 'is-invalid' : '' }}" type="text"
                        name="morals" id="morals" value="{{ old('morals', '') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('manager_word') ? 'is-invalid' : '' }}" name="manager_word"
                        id="manager_word">{{ old('manager_word') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone_number_2') ? 'is-invalid' : '' }}" type="text"
                        name="phone_number_2" id="phone_number_2" value="{{ old('phone_number_2', '') }}">
