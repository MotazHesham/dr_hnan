    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('writer') ? 'is-invalid' : '' }}" type="text" name="writer" id="writer" value="{{ old('writer', $article->writer) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('acticve') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="acticve" id="acticve" value="1" {{ $article->acticve || old('acticve', 0) === 1 ? 'checked' : '' }} required>
