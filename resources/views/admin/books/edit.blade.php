        ...
        <form method="POST" action="{{ route("admin.books.update", [$book->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $book->active || old('active', 0) === 1 ? 'checked' : '' }} required>
                    <label class="required form-check-label" for="active">{{ trans('cruds.book.fields.active') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.book.fields.active_helper') }}</span>
            </div>
            <div class="form-group">
