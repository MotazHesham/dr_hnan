...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('client.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('client.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('client.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('client.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('client.messenger.reply', compact('topic', 'unreads'));
    }
