...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('consultant.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('consultant.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('consultant.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('consultant.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('consultant.messenger.reply', compact('topic', 'unreads'));
    }
