...
class PartnersController extends Controller
{
    ...
    { 
        ...
        if ($request->input('photo', false)) {
            $partner->addMedia(storage_path('tmp/uploads/' . basename($request->input('photo'))))->toMediaCollection('photo');
        } 
    ...
    public function update(UpdatePartnerRequest $request, Partner $partner)
    {
        ...
        if ($request->input('photo', false)) {
            if (! $partner->photo || $request->input('photo') !== $partner->photo->file_name) {
                if ($partner->photo) {
